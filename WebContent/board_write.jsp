	...
	<div class="container">
		...
		<div class="row">
			<div class="box">
				...
				<form>
					<div style="padding: 20px" class="row control-group">
						<label>제목</label>
					...
					<div style="padding: 20px" class="row control-group">
						<label>닉네임</label>
						<div class="form-group">
							<input type="text" id="nname" name="nname" class="form-control"
								placeholder="닉네임"> 
					...
					<div style="padding: 20px" class="row control-group">
						...
						<div class="form-group">
							<input type="text" id="date"
								name="date" class="form-control" placeholder="날짜">
						</div>
					</div>
					...
					<div style="padding: 20px" class="row control-group">
						<label>리뷰</label>
						<div class="form-group">
							<textarea class="form-control" rows="15" id="review"
								name="reiview" placeholder="리뷰를 등록해주세요."></textarea>
						</div>
					</div>


					<div class="form-group col-lg-12">
						<input type="hidden" name="save" value="qna">
